...
from tools.online import _resolve_server_configuration, _unique_username  # noqa: E402

from src.config import section  # noqa: E402
from src.online.env import make_maskable_env  # noqa: E402
from src.online.init import configure_action_head  # noqa: E402
...
def main():
    ...
    # Mirror training architecture to avoid head shape mismatches.
    ...
    # Create a fresh model, then load parameters with relaxed matching.
